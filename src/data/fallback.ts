...
export const fallbackDevices: DeviceProfile[] = [
  ...
  { id: "phone", name: "Alex's Phone", type: "cellphone", ip: "192.168.1.101", mac: "Randomized", trust: "trusted", access: "Full", firstSeen: "Jun 18", lastSeen: "1 min ago", discoverySource: "Neighbor table", riskReasons: [] },
